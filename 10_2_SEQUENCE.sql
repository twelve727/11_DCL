...
--     매번 시퀀스를 생성해서 반환하는 것보다 DB속도가 향상됨.
    ...
    ** 시퀀스 사용 방법 **
    ...
    2) 시퀀스명.CURRVAL : 현재 시퀀스 번호 얻어옴. (CURRENT VALUE 번호)
...
-- KH-SEQUENCE - 999999999 <- 10의 38승

-- CURRVAL 주의사항
--> CURRVAL은 마지막 NEXTVAL 호출 값을 다시 보여주는 기능
--> NEXTVAL를 먼저 호출해야 CURRVAL 호출이 가능하다!!!!!!!!!!

-- 생성되자마자 바로 현재 값 확인
SELECT SEQ_TEST.CURRVAL
FROM DUAL;
-- 시퀀스 SEQ_TEST.CURRVAL은 이 세션에서는 정의 되어 있지 않습니다
...
START WITH 223 -- 223번부터 시작함
INCREMENT BY 10 -- 10씩 증가
NOCYCLE -- 반복안함 ( 반복 안하는게 기본값)
NOCACHE; -- 캐시안함 ( 캐시는 20 기본값)
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '이길동'); -- 245
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '이길동'); -- 246
